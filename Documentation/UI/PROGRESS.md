...
- 레이아웃 보정 커밋 `f6976e781ca5fc5dacc6d230f0713f1a95118f8d` GitHub 반영. 새 CI 실행 중: https://github.com/kuzuni/20260920/actions/runs/35507023694 .
- f6976e7 CI는 35/35 통과, 109장 캡처를 내려받아 실제 열람 완료. 세로 주요 레이아웃/메뉴 비율과 서비스 화면은 시안에 가까워짐.
- 시각 검토 후 추가 보정: 상세창 약120px 빈 공간 제거, 짧은 화면의 장착 정보/확률 상단 축소로 첫 목록 행 노출, 결과 요약 아이콘·레벨 중앙 묶음.
- 다음 작업: 추가 보정 통합/새 CI → 변경된 캡처 확인 → PR/기록 갱신.
