...
- 방향·뽑기 후속 검증: 10테마×3종×2프레임의 원본 방향 정규화와 좌우 이동·수직/정지·보스 반전. 레벨1~30 확률합/등급 해금/일반·고급 최소10%, Lv.30의 전체10000개 추첨 구간, 최대레벨/저장 이관, 유물 동일20%와 레벨/경험치 미표시를 검사한다. `revision-facing-theme-*`, `revision-summon-level-30*`, `revision-relic-*`를 서버에서 캡처한다.
